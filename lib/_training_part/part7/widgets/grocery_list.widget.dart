import 'package:first_app/_training_part/part7/providers/grocery.provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

import '../models/grocery_item.model.dart';
import 'new_grocery_item_riverpod.dart';
...
class _GroceryListState extends ConsumerState<GroceryList> {
  ...
  void navigationToNewGroceryItem() async {
    ...
    ).push<GroceryItem>(MaterialPageRoute(builder: (context) => const NewGroceryItemRiverpod()));
